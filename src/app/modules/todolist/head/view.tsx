...
const View = () => {
  ...
  const toggleFunctionVisibility = () => {
    setIsFunctionVisible(!isFunctionVisible); 
  };
  ...
  return (
    <div>
      <button
        onClick={toggleFunctionVisibility}
        aria-label="View options menu"
        aria-describedby="view-options-menu-description"
        aria-disabled="false"
        className="Menu"
      >
   ...
   <button onClick={() => setView("View")}> View </button>
      ...
      <Function isVisible={isFunctionVisible} />
    </div>
  );
};
